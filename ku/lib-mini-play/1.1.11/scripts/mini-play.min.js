...
, function(e, t, n) {
    ...
    var k = {
        ...
        _createContents: function() {
            ...
            this.miniLinkNext.innerText = "观看正片";
            this._setPagelet()
        },
...
, function(e, t, n) {
    ...
    t.load = function(e) {
        ...
        if (window.performance && window.performance.now) {
            ...
            m(v, "request_time", b),
            m(v, "whole_time", b),
            m(v, "vid", PageConfig.videoId),
            m(v, "page_version", "YNPP"),
            v);
            (window.goldlog_queue || (window.goldlog_queue = [])).push({
                action: "goldlog.record",
...
, function(e, t, n) {
    ...
    var E = i.default.extend({
        ...
        _loadflash: function() {
            ...
            if (PageConfig.removePlayerSideControl)
                n.show_ce = 0;
            else
                n.show_ce = 1;
...
, function(e, t) {
    ...
    function n(e, t) {
        ...
        for (o = 0; o < 256; o++) {
            r = (r + n[o] + e.charCodeAt(o % e.length)) % 256;
            i = n[o];
            n[o] = n[r];
            n[r] = i
        }
        ...
        for (var u = 0; u < t.length; u++) {
            ...
            n[o] = n[r];
            n[r] = i;
            s += String.fromCharCode(t.charCodeAt(u) ^ n[(n[o] + n[r]) % 256])
        }
        return s
    }
    function r(e) {
        ...
        while (s < o) {
            ...
            } while (s < o && t == -1);if (t == -1)
                break;
            do {
                n = a[e.charCodeAt(s++) & 255]
            } while (s < o && n == -1);if (n == -1)
                break;
    ...
    var S = $.extend(new i.default, {
        ...
        setLoginBg: function() {
            $.ajax({
                ...
                success: function(t) {
                    if (t.e.code == 0) {
                        if (t.data.loginpic.daytimepic)
                            l = t.data.loginpic.daytimepic;
                        if (t.data.loginpic.eveningpic)
                            h = t.data.loginpic.eveningpic;
    ...
    var n = {
        ...
        Common: {
            decodeBase64: function(t) {
                ...
                } while (l < t.length);return this.utf8To16(r)
            },
            encode64: function(t) {
                if (!t) {
                    return ""
            ...
            Md5: function(t) {
                ...
                var r = function U(e, t) {
                    ...
                    if (U & n)
                        return s ^ 2147483648 ^ r ^ i;
                    if (U | n) {
                        if (s & 1073741824)
                            return s ^ 3221225472 ^ r ^ i;
                        else
                            return s ^ 1073741824 ^ r ^ i
                    } else {
                        return s ^ r ^ i
                    }
                };
    ...
    function h(e, t, i, s) {
        ...
        if (o) {
            ...
            if (c.ie && c.win) {
                ...
                if (s)
                    h += '<div class="player_html5"><div class="picture"style="height:100%"><div style="line-height:460px;"><span style="font-size:18px">您还没有安装flash播放器,请点击<a href="https://get.adobe.com/flashplayer/" target="_blank">这里</a>安装</span></div></div></div>';
                h += "</object>"
            } else {
    ...
    !(r = function() {
        function n(e) {
            ...
            case "object":
                if (null === e)
                    return true;
                if (undefined !== e.length && e.length == 0)
                    return true;
                for (var t in e) {
                    return false
                }
        ...
        var r = {
            ...
            callback: function() {
                if (info == null)
                    return;
                try {
                    if ((typeof info === "undefined" ? "undefined" : i(info)) != "object")
        ...
        var u = function(t) {
            if (typeof t == "undefined" || t == null || t == "null" || t.length == 0)
                return "";
        ...
        var h = function() {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                if (s.indexOf("u=") == 0 || s.indexOf("k=") == 0)
                    var o = s;
                if (s.indexOf("_l_lgi=") == 0)
                    var u = s;
                if (s.indexOf("yktk=") == 0) {
...
, function(e, t) {
    ...
    function f(e, t) {
        e[t >> 5] |= 128 << t % 32,
        e[(t + 64 >>> 9 << 4) + 14] = t;
        var r, i, f, l, c, h = 1732584193, p = -271733879, d = -1732584194, v = 271733878;
        for (r = 0; r < e.length; r += 16) {
            i = h,
            f = p,
            l = d,
            c = v,
            h = s(h, p, d, v, e[r], 7, -680876936),
            v = s(v, h, p, d, e[r + 1], 12, -389564586),
            d = s(d, v, h, p, e[r + 2], 17, 606105819),
            p = s(p, d, v, h, e[r + 3], 22, -1044525330),
            h = s(h, p, d, v, e[r + 4], 7, -176418897),
            v = s(v, h, p, d, e[r + 5], 12, 1200080426),
            d = s(d, v, h, p, e[r + 6], 17, -1473231341),
            p = s(p, d, v, h, e[r + 7], 22, -45705983),
            h = s(h, p, d, v, e[r + 8], 7, 1770035416),
            v = s(v, h, p, d, e[r + 9], 12, -1958414417),
            d = s(d, v, h, p, e[r + 10], 17, -42063),
            p = s(p, d, v, h, e[r + 11], 22, -1990404162),
            h = s(h, p, d, v, e[r + 12], 7, 1804603682),
            v = s(v, h, p, d, e[r + 13], 12, -40341101),
            d = s(d, v, h, p, e[r + 14], 17, -1502002290),
            p = s(p, d, v, h, e[r + 15], 22, 1236535329),
            h = o(h, p, d, v, e[r + 1], 5, -165796510),
            v = o(v, h, p, d, e[r + 6], 9, -1069501632),
            d = o(d, v, h, p, e[r + 11], 14, 643717713),
            p = o(p, d, v, h, e[r], 20, -373897302),
            h = o(h, p, d, v, e[r + 5], 5, -701558691),
            v = o(v, h, p, d, e[r + 10], 9, 38016083),
            d = o(d, v, h, p, e[r + 15], 14, -660478335),
            p = o(p, d, v, h, e[r + 4], 20, -405537848),
            h = o(h, p, d, v, e[r + 9], 5, 568446438),
            v = o(v, h, p, d, e[r + 14], 9, -1019803690),
            d = o(d, v, h, p, e[r + 3], 14, -187363961),
            p = o(p, d, v, h, e[r + 8], 20, 1163531501),
            h = o(h, p, d, v, e[r + 13], 5, -1444681467),
            v = o(v, h, p, d, e[r + 2], 9, -51403784),
            d = o(d, v, h, p, e[r + 7], 14, 1735328473),
            p = o(p, d, v, h, e[r + 12], 20, -1926607734),
            h = u(h, p, d, v, e[r + 5], 4, -378558),
            v = u(v, h, p, d, e[r + 8], 11, -2022574463),
            d = u(d, v, h, p, e[r + 11], 16, 1839030562),
            p = u(p, d, v, h, e[r + 14], 23, -35309556),
            h = u(h, p, d, v, e[r + 1], 4, -1530992060),
            v = u(v, h, p, d, e[r + 4], 11, 1272893353),
            d = u(d, v, h, p, e[r + 7], 16, -155497632),
            p = u(p, d, v, h, e[r + 10], 23, -1094730640),
            h = u(h, p, d, v, e[r + 13], 4, 681279174),
            v = u(v, h, p, d, e[r], 11, -358537222),
            d = u(d, v, h, p, e[r + 3], 16, -722521979),
            p = u(p, d, v, h, e[r + 6], 23, 76029189),
            h = u(h, p, d, v, e[r + 9], 4, -640364487),
            v = u(v, h, p, d, e[r + 12], 11, -421815835),
            d = u(d, v, h, p, e[r + 15], 16, 530742520),
            p = u(p, d, v, h, e[r + 2], 23, -995338651),
            h = a(h, p, d, v, e[r], 6, -198630844),
            v = a(v, h, p, d, e[r + 7], 10, 1126891415),
            d = a(d, v, h, p, e[r + 14], 15, -1416354905),
            p = a(p, d, v, h, e[r + 5], 21, -57434055),
            h = a(h, p, d, v, e[r + 12], 6, 1700485571),
            v = a(v, h, p, d, e[r + 3], 10, -1894986606),
            d = a(d, v, h, p, e[r + 10], 15, -1051523),
            p = a(p, d, v, h, e[r + 1], 21, -2054922799),
            h = a(h, p, d, v, e[r + 8], 6, 1873313359),
            v = a(v, h, p, d, e[r + 15], 10, -30611744),
            d = a(d, v, h, p, e[r + 6], 15, -1560198380),
            p = a(p, d, v, h, e[r + 13], 21, 1309151649),
            h = a(h, p, d, v, e[r + 4], 6, -145523070),
            v = a(v, h, p, d, e[r + 11], 10, -1120210379),
            d = a(d, v, h, p, e[r + 2], 15, 718787259),
            p = a(p, d, v, h, e[r + 9], 21, -343485551),
            h = n(h, i),
            p = n(p, f),
            d = n(d, l),
            v = n(v, c)
    ...
    function l(e) {
        ...
        for (t = 0; t < 32 * e.length; t += 8) {
            n += String.fromCharCode(255 & e[t >> 5] >>> t % 32)
        }
        return n
    }
    function c(e) {
    ...
    function p(e, t) {
        ...
        return r = f(s.concat(c(t)), 512 + 8 * t.length),
        l(f(o.concat(r), 640))
    }
    function d(e) {
        ...
        for (n = 0; n < e.length; n += 1) {
            t = e.charCodeAt(n),
            i += r.charAt(15 & t >>> 4) + r.charAt(15 & t)
        }
        return i
    }
    function v(e) {
        ...
        initFixedBar: function() {
            ...
            window.setTimeout(function() {
                ...
                if (e.length && $(".drama-fragment").children().length) {
                    n = $('<div class="drama-bottom-fixed"><h3 class="drama-title">节目相关片段</h3> <i class="scroll-bottom-fixed"></i></div>');
                    t.$el.append(n)
                }
    ...
    function c(e, t, n) {
        ...
        f(e).done(function(i) {
            ...
            if (i[0] === true) {
                ...
                (0,
                o.default)("ConditionException::" + a + "::" + i)
            }
        }).fail(function(e, i, u) {
            console.log(i);
            var f = i || u;
            ...
            if (l) {
                (0,
                o.default)("FirstAutoRetry::" + a + "::" + f + "::" + s);
                r[t].apply(r, n.concat(["retry"]))
            } else {
                (0,
                o.default)("retryError::" + a + "::" + f + "::" + s)
            }
            r.fire(t + ":error", [{
                status: f,
                msg: f
...
, function(e, t, n) {
    ...
    function p() {
        var e = (0,
        i.default)("seid");
        if (!e || +(new Date) > (parseInt((0,
        i.default)("seidtimeout")) || 0)) {
            e = a.default.rand((0,
            i.default)("u_id"), "0");
            (0,
            i.default)("seid", e, {
        ...
        var t = (0,
        i.default)("referhost");
        if (!t || +(new Date) > (parseInt((0,
        i.default)("seidtimeout")) || 0)) {
            var n = /^https?:\/\/[^\/]+/.exec(document.referrer || "");
            t = n ? n[0] : "";
            (0,
            i.default)("referhost", t, {
                domain: "youku.com",
                path: "/"
            })
        }
        (0,
        i.default)("seidtimeout", Date.now() + 30 * 6e4, {
            domain: "youku.com",
            path: "/"
        });
        return e
...
, function(e, t, n) {
    ...
    var l = i.default.extend({
        ...
        getVideoPlayInfo: function(t) {
            var n = this;
            o.default.getJSON(this.domain + "action/getVideoPlayInfo?" + "&timestamp=" + (new Date).getTime(), t, function(e) {
                if (e.error == 1) {
        ...
        addFav: function(t) {
            ...
            $.ajax({
                ...
                success: function(t) {
                    if (t.error == 0 || t.error == -1 || t.error == 2) {
                        n.trigger("addFav:success", [t.error])
                    } else {
...
, function(e, t, n) {
    ...
    var d = n(68);
    var v = n(69);
    var m = i.default.extend({
        el: $(".js-player-container"),
        initialize: function(t) {
            var n = this;
            this.$el = $(".js-player-container");
            if (!this.$el.length) {
                return
            }
            this.mod = new h.default;
            ...
            n.locked = false;
            window.ykPlyr && ykPlyr.bind("player:onPlayerStartUpdate", function() {
                n.status()
            });
            $(document).bind("logchange", function() {
                if (n.locked)
        ...
        render: function(t) {
            var n = void 0
              , r = void 0;
            t.isSelf = false;
            if (l.default.uid() == PageConfig.videoOwner) {
                t.isSelf = true
            }
            if ($("#module_basic_dayu_sub").length) {
                t.subcount = a.default.field(t.subcount);
                t.vvCount = a.default.field(t.vvCount);
                r = o.default.compile(d)({
                    data: t
                });
                $("#module_basic_dayu_sub").html(r)
            }
            if ($("#module_basic_sub").length) {
                n = o.default.compile(v)({
                    data: t
                });
...
, function(e, t) {
    ...
    function n(e, t) {
        ...
        if (i.length < t) {
            n = (new Array(t - i.length + 1)).join("0")
        }
        return (r ? "-" : "") + n + i
    }
    function r(e, t) {
        t = t.length;
        e = e || 0;
        return parseInt(t, 10) === 1 ? e : (e = String(Math.pow(10, t) + e)).substr(e.length - t)
    }
    function i(e, t) {
        t = t || ",";
        return String(e).replace(/(\d)(?=(\d{3})+($|\.))/g, "$1" + t)
    }
    function s(e) {
        e = parseInt(e);
        var t = void 0;
    ...
    function o(e) {
        ...
        do {
            e /= 1024;
            t++
        } while (e > 1024);return Math.max(e, .1).toFixed(1) + ["KB", "MB", "GB", "TB"][t]
    }
    e.exports = {
        pad: n,
        format: r,
...
, function(e, t, n) {
    ...
    var d = i.default.extend({
        ...
        getStatRank: function(t) {
            var n = this;
            o.default.getJSON(this.domain + "related/statRank?" + "t=" + (new Date).getTime(), t, function(e) {
                if (e.error == 1) {
        ...
        getRelation: function(t) {
            var n = this;
            o.default.getJSON("//ykrec.youku.com/show/packed/list.json?t=" + new Date * 1, t, function(e) {
        ...
        getStar: function(t) {
            var n = this;
            o.default.getJSON(this.domain + "related/star?" + "&t=" + (new Date).getTime(), t, function(e) {
                if (e.error == 0) {
        ...
        createSubMtop: function(t) {
            var n = this;
            t.guid = (0,
            a.default)("__ysuid") || "47427125262Ne";
            h.default.requestMtop({
...
, function(e, t, n) {
    ...
    function f(e, t, n) {
        ...
        if (i <= 60) {
            ...
            return Math.floor(i / 60) + "分钟前"
        } else if (i <= s) {
            return Math.floor(i / 3600) + "小时前"
        } else if (i <= s + a) {
            return "昨天"
        } else if (i <= s + a * 2) {
            return "前天"
        } else if (i <= s + a * 7) {
            return Math.floor(i / a) + "天前"
        } else if (i <= s + a * 25) {
            return Math.floor(i / (a * 7)) + "周前"
        } else {
            return u(n, e)
        }
    }
    ...
    function h(e, t, n) {
        ...
        var i = r.getHours();
        if (r > 432e5) {
            i += Math.floor(r / 432e5)
        }
        if (n) {
            e = e.replace(/(\w)\1+/g, "$1")
        }
        return e.replace(/([hms])\1*/g, function(t) {
            switch (t.charAt()) {
            case "h":
                return o(i - 8, t);
            case "m":
                var n = (/h+/.test(e) ? 0 : i - 8) * 60 + r.getMinutes();
                return o(n, t);
            case "s":
                return o(r.getSeconds(), t)
            }
        })
    }
    function p(e, t) {
        if (e < 36e5) {
            return this.formatTime("mm:ss", e, t)
        } else {
            return this.formatTime("hh:mm:ss", e, t)
        }
    }
    var r = n(63);
    var i = s(r);
    var o = i.default.format;
    var a = 24 * 60 * 60;
    e.exports = {
        release: f,
        formatDate: u,
...
, function(e, t) {
    ...
    !function(e, t) {
        ...
        d.prototype.__processRequestType = function(n) {
            var r = this
              , i = this.params
              , s = this.options;
            if (g.H5Request === !0 && (s.H5Request = !0),
            g.WindVaneRequest === !0 && (s.WindVaneRequest = !0),
            s.H5Request === !1 && s.WindVaneRequest === !0) {
                if (!w && (!t.windvane || parseFloat(s.WindVaneVersion) < 5.4))
                    throw new Error("WINDVANE_NOT_FOUND::缺少WindVane环境");
                if (w && !e.AlipayJSBridge)
                    throw new Error("ALIPAY_NOT_READY::支付宝通道未准备好，支付宝请见 https://lark.alipay.com/mtbsdkdocs/mtopjssdkdocs/pucq6z")
            } else if (s.H5Request === !0)
                s.WindVaneRequest = !1;
            else if ("undefined" == typeof s.WindVaneRequest && "undefined" == typeof s.H5Request && (t.windvane && parseFloat(s.WindVaneVersion) >= 5.4 ? s.WindVaneRequest = !0 : s.H5Request = !0,
            w))
                if (s.WindVaneRequest = s.H5Request = void 0,
                e.AlipayJSBridge)
                    if (a(i.data))
                        s.WindVaneRequest = !0;
                    else
            ...
            return u.indexOf("youku") > -1 && s.mainDomain.indexOf("youku.com") < 0 && (s.WindVaneRequest = !1,
            s.H5Request = !0),
            s.mainDomain.indexOf("youku.com") > -1 && u.indexOf("youku") < 0 && (s.WindVaneRequest = !1,
            s.H5Request = !0),
            n ? n().then(function() {
                var e = s.retJson.ret;
                if (e instanceof Array && (e = e.join(",")),
                s.WindVaneRequest === !0 && w && s.retJson.error || !e || e.indexOf("PARAM_PARSE_ERROR") > -1 || e.indexOf("HY_FAILED") > -1 || e.indexOf("HY_NO_HANDLER") > -1 || e.indexOf("HY_CLOSED") > -1 || e.indexOf("HY_EXCEPTION") > -1 || e.indexOf("HY_NO_PERMISSION") > -1) {
                    if (!w || !isNaN(s.retJson.error) || -1 !== s.retJson.error.indexOf("FAIL_SYS_ACCESS_DENIED"))
                        return w && a(i.data) && (i.data = JSON.stringify(i.data)),
                        g.H5Request = !0,
                        r.__sequence([r.__processRequestType, r.__processToken, r.__processRequestUrl, r.middlewares, r.__processRequest]);
                    "undefined" == typeof s.retJson.api && "undefined" == typeof s.retJson.v && (s.retJson.api = i.api,
                    s.retJson.v = i.v,
        ...
        d.prototype.__processToken = function(e) {
            ...
            n.WindVaneRequest !== !0 ? m.then(function() {
                ...
                r.indexOf("TOKEN_EMPTY") > -1 || n.CDR === !0 && r.indexOf("ILLEGAL_ACCESS") > -1 || r.indexOf("TOKEN_EXOIRED") > -1) {
                    ...
                    n.maxRetryTimes > 0 && (c(x, n.pageDomain, "*"),
                    c(T, n.mainDomain, n.subDomain),
                    c(N, n.mainDomain, n.subDomain)),
        ...
        d.prototype.__requestJSON = function(t) {
            ...
            u.getJSON ? (h = "GET",
            d += "&" + s(u.postdata)) : u.postJSON && (h = "POST",
            p = s(u.postdata)),
            a.open(h, d, !0),
            a.withCredentials = !0,
        ...
        d.prototype.__requestWindVane = function(e) {
            ...
            var h, p, d = "https" === location.protocol ? 1 : 0, v = s.isSec || 0, m = s.sessionOption || "AutoLoginOnly", g = s.ecode || 0, y = s.ext_headers || {}, b = s.ext_querys || {};
        ...
        d.prototype.__processRequest = function(e, t) {
            ...
            return m.then(function() {
                ...
                if (e.WindVaneRequest)
                    return w ? n.__requestAlipay(t) : n.__requestWindVane(t);
        ...
        d.prototype.request = function(n) {
            var i = this;
            if (this.options = r(n || {}, g),
            !v) {
                var s = "当前浏览器不支持Promise，请在windows对象上挂载Promise对象可参考（http://gitlab.alibaba-inc.com/mtb/lib-es6polyfill/tree/master）中的解决方案";
                throw t.mtop = {
                    ERROR: s
                },
                new Error(s)
            ...
            var u = v.resolve([k, L]).then(function(e) {
                ...
                i.options.failureCallback ? void i.options.failureCallback(t) : v.reject(t)
            });
            return this.__processRequestType(),
            i.options.H5Request && (i.constructor.__firstProcessor || (i.constructor.__firstProcessor = u),
            k = function(e) {
    ...
    function(e, t) {
        ...
        function i(t, r) {
            ...
            a > 800 && (l.style.cssText = ["width:370px", "height:52px", "background:#EEE", "line-height:52px", "text-align:left", "box-sizing:border-box", "padding-left:20px", "position:absolute", "left:" + (a / 2 - 185) + "px", "top:40px", "font-size:16px", "font-weight:bold", "color:#333"].join(";"),
            h.style.cssText = ["position:absolute", "top:92px", "left:" + (a / 2 - 185) + "px", "width:370px", "height:480px", "border:0", "background:#FFF", "overflow:hidden"].join(";")),
            l.appendChild(c),
            o.appendChild(l),
            o.appendChild(h),
        ...
        function s(e) {
            ...
            return e().then(function() {
                ...
                (s.indexOf("SESSION_EXPIRED") > -1 || s.indexOf("SID_INVALID") > -1 || s.indexOf("AUTH_REJECT") > -1 || s.indexOf("NEED_LOGIN") > -1) && (e.retType = c.SESSION_EXPIRED,
                !r.WindVaneRequest && (l.LoginRequest === !0 || r.LoginRequest === !0 || i.needLogin === !0))) {
                    if (!t.login)
                        throw new Error("LOGIN_NOT_FOUND::缺少lib.login");
                    if (r.safariGoLogin !== !0 || !u || "taobao.com" === r.pageDomain)
        ...
        function u(t) {
            ...
            return o.forceAntiCreep !== !0 && s.H5Request !== !0 || l.AntiCreep !== !0 && s.AntiCreep !== !0 ? void t() : t().then(function() {
                ...
                (u.indexOf("RGV587_ERROR::SM") > -1 || u.indexOf("ASSIST_FLAG") > -1) && t.data.url) {
                    var f = "_m_h5_smt"
                      , l = r(f)
                      , c = !1;
                        ...
                        function l(t) {
                            ...
                            if (i && "child" === i.type) {
                                ...
                                try {
                                    ...
                                    for (var v in p)
                                        o[v] = p[v];
                                    s.saveAntiCreepToken === !0 ? (document.cookie = f + "=" + JSON.stringify(p) + ";",
                                    e.location.reload()) : n.__sequence([n.__processToken, n.__processRequestUrl, n.__processUnitPrefix, n.middlewares, n.__processRequest]).then(r)
                                } catch (c) {
...
, function(e, t, n) {
    ...
    var u = {
        init: function() {
            ...
            i.default)(this.checkShow.bind(this), 300));
